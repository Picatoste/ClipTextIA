...
namespace ClipTextIA
{
    public class HotkeyService : IHotkeyService
    {
        ...
        public void AutoRegisterHotkeyAfter(TimeSpan afterTimeSpan, Action onHotkeyPressed, Func<KeyEventArgs, bool> onHotkeysRegisteredCheck)
        {
            ...
            timer.Tick += (s, e) =>
            {
                ...
                if (!HotkeyActive)
                {
                    RegisterHotkey(onHotkeyPressed, onHotkeysRegisteredCheck);
                }
            };
            timer.Start();
        }
